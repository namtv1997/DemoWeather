...
object Common {
  var stateDegree=0
  const val Type_Degree_C=0
  const val Type_Degree_F=1
  const val Type_Degree_K=2
  const val Type_HUMIDITY_PERCENT=0
  const val Type_HUMIDITY_ABSOLUTE=1
  const val Type_WIND_KM=0
  const val Type_WIND_MILES=1
  const val PREFS_NAME = "PREFS_NAME"
  const val KEY_TYPE_HUMIDITY_CUSTOM_SELECTED = "KEY_TYPE_HUMIDITY_CUSTOM_SELECTED"
  const val KEY_TYPE_WIND_CUSTOM_SELECTED = "KEY_TYPE_WIND_CUSTOM_SELECTED"
  const val KEY_TYPE_DEGREE_CUSTOM_SELECTED = "KEY_TYPE_DEGREE_CUSTOM_SELECTED"
